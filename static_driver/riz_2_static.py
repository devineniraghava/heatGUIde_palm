...
Note:
This file contains the code to create the Static Driver with pixel based individual building 
parameters. An improvement from riz_1_static.py
...
path = '/home/rdevinen/Documents/GitHub/heatGUIde_palm/static_driver/files/riz_2_static'
nc_file = Dataset(path, 'w', format='NETCDF4')
nc_file.title = 'RIZ static driver with pixel detailing'
